#!/usr/bin/env python
# -*- coding:utf-8 -*-
# @FileName  :data_converters_utils.py
# @Time      :2025/7/2 10:13:07
# @Author    :雨霓同学
# @Project   :SafeYolo
...
from utils.paths import YOLOSERVER_ROOT, RAW_DATA_DIR, YOLO_STAGED_LABELS_DIR, ORIGINAL_ANNOTATIONS_DIR
...
def convert_data_to_yolo(input_dir: Path,
    ...
    :param coco_task: 针对coco json数据集设定的参数，确定任务类别，
    :param coco_cls91to80: coco jsop特有参数，设定后可以将coco 91种类别映射为80类，一般不做设置
    :return: 返回转换的列表
    """
